# Como instalar os mods (Forge) para jogar no servidor
...
## 1) Instalar o Forge (Minecraft 1.20.1)

1. Baixe o instalador do Forge para **Minecraft 1.20.1 (47.x)**.
2. Abra o arquivo do Forge e escolha **Install client**.
3. Finalize a instalação.
4. Abra o Minecraft Launcher.
5. No seletor de versão, escolha o perfil **Forge 1.20.1** e clique em **Jogar** pelo menos 1 vez.
   - Isso cria as pastas necessárias (incluindo a pasta `mods`).

---

## 2) Baixar os mods (.jar)
